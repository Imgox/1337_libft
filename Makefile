...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/10/07 22:32:19 by ysalahed          #+#    #+#              #
#    Updated: 2018/10/17 00:14:50 by slaanani         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_bzero.c ft_memset.c ft_memcpy.c\
	  ...
	  ft_putchar_fd.c ft_putstr.c ft_putendl.c\
	  ft_putnbr.c ft_putstr_fd.c ft_putendl_fd.c\
	  ft_putnbr_fd.c ft_lstnew.c ft_lstdelone.c\
	  ft_lstdel.c ft_lstadd.c ft_lstiter.c ft_lstmap.c\
	  ft_abs.c ft_count_words.c ft_power.c ft_factorial.c\
	  ft_is_even.c
